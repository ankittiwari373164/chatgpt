...
function augmentPrompt(basePrompt, client) {
    ...
    parts.push(
        ...
        "- Post should be conceptual not normal."
    );
    ...
    if (logo && footer) {
        ...
        parts.push(
            ...
            "",
            "REQUIREMENTS:",
            "- The logo and footer are already previously provided in the chat, use the same in the generation of post.",
            "- Post should be conceptual not normal."
        ...
        parts.push(
            ...
            "The brand logo is attached in previous message.",
            "The logo and footer are already previously provided in the chat, use the same in the generation of post.",
            "- Post should be conceptual not normal."
        );
        ...
        parts.push(
            "",
            "ATTACHED REFERENCE IMAGE:",
            "The brand footer/banner is attached in previous message.",
            "The logo and footer are already previously provided in the chat, use the same in the generation of post.",
            "- Post should be conceptual not normal."
        );
